...
function VideoBanner() {
  ...
  return (
    ...
    <button disabled className='bg-red-900 nav z-20 text-neutral-300 text-xl px-4 py-2 font-bold block opacity-80 cursor-not-allowed' aria-disabled='true'>Book Now</button>
