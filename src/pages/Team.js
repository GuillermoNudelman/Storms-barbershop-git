  ...
  return (
    <div className='min-h-screen'>
        ...
        <section className='flex flex-wrap justify-center gap-8 py-8 bg-red-950 bg-opacity-10 text-neutral-900'>
            ...
            <div className='relative'>
            <div className='absolute z-10 text-xl top-0 px-2 py-8 flex justify-center items-end gap-2 w-full text-neutral-300'>
                 <p className='font-bold'>Remi</p>
                 <p>|</p>
                 <p>Master Barber</p>
                 <p>|</p>
                 <Link className='underline' to='/team/remi'>Read More</Link>
              </div>
            ...
            <div className='relative'>
            <div className='absolute z-10 text-xl top-0 px-2 py-8 flex justify-center items-end gap-2 w-full text-neutral-300'>
                 <p className='font-bold'>Jin</p>
                 <p>|</p>
                 <p>Expert Stylist</p>
                 <p>|</p>
                 <Link className='underline' to='/team/jin'>Read More</Link>
              </div>
